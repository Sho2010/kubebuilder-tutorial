...
import (
	...
	samplecontrollerv1alpha1 "github.com/Sho2010/kubebuilder-tutorial/api/v1alpha1"
	"github.com/Sho2010/kubebuilder-tutorial/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "4f835ac3.k8s.io",
	})
	if err != nil {
